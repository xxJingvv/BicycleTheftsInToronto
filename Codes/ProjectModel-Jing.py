...
##analyzing whether to replace missing value with mean or median
import matplotlib.pyplot as plt
plt.boxplot(df_project['Cost_of_Bike'])
plt.ylabel('Cost_of_Bike ')
plt.title('Box Plot of Cost_of_Bike')
plt.show()
### Handling missing values
df_project['Cost_of_Bike'].fillna(df_project['Cost_of_Bike'].mean(),inplace=True)
